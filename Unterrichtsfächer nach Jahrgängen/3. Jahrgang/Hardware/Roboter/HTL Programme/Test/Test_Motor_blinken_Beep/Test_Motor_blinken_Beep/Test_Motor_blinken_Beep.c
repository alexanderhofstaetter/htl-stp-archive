////////////////////////////////////////////////////////////////////////////////
//
// PRO-BOT128 mit ATmega32u4 Test Motorsignale  (PWM: PD0, PB6, Enable: PF5)
//                           Test Beep			(PB5)
// HTL Version V1 //         Test blinken		(PB7, PD2, PB3, PB1)
//
// fquarz = 8MHz 
//
/////////////////////////////////////////////////////////////////////////////////
...
//	DDRx = DDRx | (1<<DDxy);				//P-- LED back right    nicht beschaltet
	...
	PORTB = PORTB|(1<<PORTB3)|(1<<PORTB1);	//alle LEDs aus  ohne |(1<<PORTB7)
...
// Ändern des internen CLK-Prescaler (gilt für ext. Quarz U N D int. RC-Oszillator)
...
//	beep(1);								//1=Beep starten
	...
	while(1)
	{
		...
		drive (0xFF, 0x00, 1);	_delay_ms(3000);	//OK gegen
		drive (0x80, 0x80, 0);	_delay_ms(500);
		
		drive (0x05, 0xFF, 1);	_delay_ms(3000);
		drive (0x80, 0x80, 0);	_delay_ms(500);
	}
