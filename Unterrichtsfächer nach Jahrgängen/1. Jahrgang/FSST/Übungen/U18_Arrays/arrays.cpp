...
{  srand(time(NULL));
   do
   {
       ...
       printf("  Feld a in ansteigender und absteigender Hoehe ordnen\n");
       ...
       //---Feld a in ansteigender Höhe ordnen -------------------------------------
       printf("\n Feld a in ansteigender Hoehe :");
       for (i=0;i<N;i++)
       {   for(j=i+1;j<N;j++)
           {   if(a[j]<a[i])
               {   y=a[i];
       ...
       //---Feld a in absteigender  Höhe ordnen -------------------------------------
       printf("\n Feld a in absteigender Hoehe :");
       for (i=0;i<N;i++)
       {   for(j=i+1;j<N;j++)
           {   if(a[j]>a[i])
               {   y=a[i];
