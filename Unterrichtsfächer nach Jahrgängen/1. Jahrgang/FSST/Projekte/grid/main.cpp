...
int main()
{
       ...
       initwindow(640,320,"WinBGIm Demo");      // Grafikfenster  erzeugen mit Breite=640, Höhe=480 und Beschriftung
       ...
       setcolor(LIGHTGRAY);
       outtextxy(500,10," by di w.alfery ");     // Text an der Position x=500, y=10 ausgeben
