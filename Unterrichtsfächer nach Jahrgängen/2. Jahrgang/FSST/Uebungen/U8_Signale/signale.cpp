...
float signal[NMAX], signal1[NMAX];     // Signal Array
...
int main()
{
    ...
    do
    {
        ...
        array_out(signal, NMAX);
        printf("\n\n Mittelwert = %f",array_mittel(signal,0,NMAX-1));
        printf("\n Maximum (Spitzenwert) = %f",array_max(signal,0,NMAX-1));
        printf("\n Minimum = %f",array_min(signal,0,NMAX-1));
        printf("\n RMS (echter Effektivwert) = %f",array_rms(signal,NMAX));
